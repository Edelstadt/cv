...
\gray Období & \textbf{2022--}\\
\gray Zaměstnavatel & \textbf{wf tech} \hfill Kladno (remote)\\
\gray Pozice & \textbf{DevOps technik}\\
       & Vývoj a správa infrastruktury, CI/CD, monitoringu, správa aplikací, automatizace. Primárně v Ansiblu, ale okrajově i Kubernetes a AWS (terraform, terragrunt)
\end{tabularx}
